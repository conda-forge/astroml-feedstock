About astroml-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/astroml-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2726&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/astroml-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `astroml` can be installed with `conda`:
...
```
mamba install astroml
```

It is possible to list all of the versions of `astroml` available on your platform with `conda`:
...
```
mamba search astroml --channel conda-forge
```
...
mamba repoquery search astroml --channel conda-forge

# List packages depending on `astroml`:
mamba repoquery whoneeds astroml --channel conda-forge

# List dependencies of `astroml`:
mamba repoquery depends astroml --channel conda-forge
```
